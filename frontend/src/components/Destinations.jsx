      ...
      <>
        ...
        >
          ...
          <header className="px-6 md:px-8 pt-16 pb-12 max-w-7xl mx-auto">
            ...
            <h1 className="font-display text-5xl md:text-7xl text-balance leading-[0.95] capitalize">
              {dest.name}
            </h1>
          </header>
      ...
      >
        <header className="px-6 md:px-8 pt-16 pb-12 max-w-7xl mx-auto">
          ...
          <h1 className="font-display text-5xl md:text-7xl text-balance leading-[0.95] max-w-3xl">
            The places we <span className="italic text-primary">take you.</span>
          </h1>
        </header>

        <section className="px-6 md:px-8 pb-24 max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {contents.map((ele) => (
            <article
              key={ele._id}
            ...
            >
              ...
              <span className="font-mono text-xs uppercase tracking-widest text-primary border-b border-primary pb-1">
                Explore
              </span>
            </article>
          ))}
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {contents
                ...
                .map((dest) => (
                  <div
                    key={dest._id}
                    className="bg-card p-6 rounded-2xl ring-1 ring-border hover:shadow-lg transition-shadow group cursor-pointer"
